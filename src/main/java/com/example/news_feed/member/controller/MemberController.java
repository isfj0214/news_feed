...
public class MemberController {
    ...
    public MemberResponseDto findByIdMember(@PathVariable Long id) {
        return memberService.findByIdMember(id);
    }

    @PutMapping("/members/{id}")
    public MemberUpdateResponseDto update(@PathVariable Long id, @RequestBody MemberUpdateRequestDto dto) {
