...
public class FriendService {
    ...
    public FriendRequestResponseDto request(FriendRequestDto friendRequestDto) {
        ...
        Member reversedMember = memberRepository.findById(friendRequestDto.getFromId()).orElseThrow(() -> new Exception404(ErrorCode.MEMBER_NOT_FOUND));
    ...
    public void cancel(FriendRequestCancelDto friendRequestCancelDto) {
        memberRepository.findById(friendRequestCancelDto.getFromId()).orElseThrow(() -> new Exception404(ErrorCode.MEMBER_NOT_FOUND));
